        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                title: Text(
                  GlobalData().blackMids.contains(moduleAuthor.mid)
                      ? '移出黑名单：${moduleAuthor.name}'
                      : '加入黑名单：${moduleAuthor.name}',
                  style: theme.textTheme.titleSmall,
                ),
                leading: Icon(
                  GlobalData().blackMids.contains(moduleAuthor.mid)
                ...
                onTap: () {
                  ...
                  if (GlobalData().blackMids.contains(mid)) {
                    ...
                    onBlock?.call();
                    try {
                      Get.find<DynamicsController>().tempBannedList.add(mid);
                    } catch (_) {}
